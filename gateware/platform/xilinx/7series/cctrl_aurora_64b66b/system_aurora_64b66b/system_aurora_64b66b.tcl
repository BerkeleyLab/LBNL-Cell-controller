...
################################################################
# This is a generated script based on design: system_aurora_64b66b
#
...
# source system_aurora_64b66b_script.tcl
...
set design_name system_aurora_64b66b
...
# Hierarchical cell: data_upconverter3
proc create_hier_cell_data_upconverter3 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_data_upconverter3() - Empty argument(s)!"}
     return
  }
  ...
  set axi_stream_sc_in [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axi_stream_sc_in ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net S_AXI_STREAM_1 [get_bd_intf_pins S_AXI_STREAM] [get_bd_intf_pins axis_data_fifo_3/S_AXIS]
  connect_bd_intf_net -intf_net auto_cc_M_AXIS [get_bd_intf_pins M_AXI_STREAM] [get_bd_intf_pins axi_stream_cc/M_AXIS]
  connect_bd_intf_net -intf_net axi_stream_dwc_M_AXIS [get_bd_intf_pins axi_stream_dwc/M_AXIS] [get_bd_intf_pins axi_stream_sc_in/S_AXIS]
  connect_bd_intf_net -intf_net axi_stream_sc_in1_M_AXIS [get_bd_intf_pins axi_stream_cc/S_AXIS] [get_bd_intf_pins axi_stream_sc_in/M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_3_M_AXIS [get_bd_intf_pins axi_stream_dwc/S_AXIS] [get_bd_intf_pins axis_data_fifo_3/M_AXIS]

  # Create port connections
  connect_bd_net -net S_CLK_1 [get_bd_pins S_CLK] [get_bd_pins axi_stream_cc/s_axis_aclk] [get_bd_pins axi_stream_dwc/aclk] [get_bd_pins axi_stream_sc_in/aclk] [get_bd_pins axis_data_fifo_3/s_axis_aclk]
  connect_bd_net -net dst_clk_1 [get_bd_pins M_CLK] [get_bd_pins axi_stream_cc/m_axis_aclk]
  connect_bd_net -net reset_n_1 [get_bd_pins reset_n] [get_bd_pins axi_stream_cc/m_axis_aresetn] [get_bd_pins axi_stream_cc/s_axis_aresetn] [get_bd_pins axi_stream_dwc/aresetn] [get_bd_pins axi_stream_sc_in/aresetn] [get_bd_pins axis_data_fifo_3/s_axis_aresetn]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: data_upconverter2
proc create_hier_cell_data_upconverter2 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_data_upconverter2() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: data_upconverter1
proc create_hier_cell_data_upconverter1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_data_upconverter1() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: data_downconverter13
proc create_hier_cell_data_downconverter13 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_data_downconverter13() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I -type clk M_CLK
  create_bd_pin -dir I -from 7 -to 0 STATUS_IN
  create_bd_pin -dir O -from 7 -to 0 STATUS_OUT
  create_bd_pin -dir I -type clk S_CLK
  create_bd_pin -dir I -type rst reset_n
  ...
  # Create instance: axi_stream_cc_sc_out, and set properties
  set axi_stream_cc_sc_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axi_stream_cc_sc_out ]
  set_property -dict [ list \
  ...
  # Create instance: bit0, and set properties
  set bit0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 bit0 ]
  set_property -dict [ list \
   CONFIG.DIN_WIDTH {8} \
 ] $bit0

  # Create instance: bit_2_to_1, and set properties
  set bit_2_to_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 bit_2_to_1 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {2} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {8} \
  ...
  # Create instance: bit_6_to_3, and set properties
  set bit_6_to_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 bit_6_to_3 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {6} \
   CONFIG.DIN_TO {3} \
   CONFIG.DIN_WIDTH {8} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_STREAM_1 [get_bd_intf_pins S_AXI_STREAM] [get_bd_intf_pins axi_stream_sc_in/S_AXIS]
  connect_bd_intf_net -intf_net auto_cc_M_AXIS [get_bd_intf_pins axi_stream_cc/M_AXIS] [get_bd_intf_pins axi_stream_dwc/S_AXIS]
  connect_bd_intf_net -intf_net auto_ds_M_AXIS [get_bd_intf_pins axi_stream_cc_sc_out/S_AXIS] [get_bd_intf_pins axi_stream_dwc/M_AXIS]
  connect_bd_intf_net -intf_net auto_ss_si_r_M_AXIS [get_bd_intf_pins axi_stream_cc/S_AXIS] [get_bd_intf_pins axi_stream_sc_in/M_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_1_M_AXIS [get_bd_intf_pins M_AXI_STREAM] [get_bd_intf_pins axi_stream_cc_sc_out/M_AXIS]

  # Create port connections
  connect_bd_net -net S_AXI_TUSER_1 [get_bd_pins STATUS_IN] [get_bd_pins bit0/Din] [get_bd_pins bit_6_to_3/Din] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net S_CLK_1 [get_bd_pins S_CLK] [get_bd_pins axi_stream_cc/s_axis_aclk] [get_bd_pins axi_stream_sc_in/aclk]
  connect_bd_net -net axi_stream_cc_sc_out_m_axis_tuser [get_bd_pins axi_stream_cc_sc_out/m_axis_tuser] [get_bd_pins bit_2_to_1/Din]
  connect_bd_net -net bit0_Dout [get_bd_pins bit0/Dout] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net bit_2_to_1_Dout [get_bd_pins bit_2_to_1/Dout] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net bit_6_to_3_Dout [get_bd_pins bit_6_to_3/Dout] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net dst_clk_1 [get_bd_pins M_CLK] [get_bd_pins axi_stream_cc/m_axis_aclk] [get_bd_pins axi_stream_cc_sc_out/aclk] [get_bd_pins axi_stream_dwc/aclk]
  connect_bd_net -net reset_n_1 [get_bd_pins reset_n] [get_bd_pins axi_stream_cc/m_axis_aresetn] [get_bd_pins axi_stream_cc/s_axis_aresetn] [get_bd_pins axi_stream_cc_sc_out/aresetn] [get_bd_pins axi_stream_dwc/aresetn] [get_bd_pins axi_stream_sc_in/aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_stream_sc_in/s_axis_tuser] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins STATUS_OUT] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconstant_0/dout]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: data_downconverter12
proc create_hier_cell_data_downconverter12 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_data_downconverter12() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: data_downconverter11
proc create_hier_cell_data_downconverter11 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_data_downconverter11() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: data_downconverter10
proc create_hier_cell_data_downconverter10 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_data_downconverter10() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_Aurora { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 7 -to 0 CORE_STATUS2
  create_bd_pin -dir O -from 7 -to 0 CORE_STATUS3
  create_bd_pin -dir O -from 7 -to 0 CORE_TEST_STATUS
  create_bd_pin -dir O -type clk auroraRefClk
  create_bd_pin -dir I -type rst auroraReset
  create_bd_pin -dir O -from 0 -to 0 gt0_qplllock_out
  create_bd_pin -dir O -from 0 -to 0 gt0_qpllrefclklost_out
  create_bd_pin -dir I -type rst gtxReset
  create_bd_pin -dir O -type rst gtxResetOut
  create_bd_pin -dir I -type clk init_clk_in
  create_bd_pin -dir O -from 0 -to 0 pll_not_locked_out
  ...
  # Create instance: aurora_64b66b_4, and set properties
  set aurora_64b66b_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:aurora_64b66b:12.0 aurora_64b66b_4 ]
  set_property -dict [ list \
   CONFIG.C_GT_CLOCK_1 {GTXQ0} \
   CONFIG.C_GT_LOC_1 {X} \
   CONFIG.C_GT_LOC_4 {1} \
  ...
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {204.8} \
   CONFIG.CLKOUT1_DRIVES {BUFG} \
   CONFIG.CLKOUT1_JITTER {181.092} \
   CONFIG.CLKOUT1_PHASE_ERROR {165.531} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {97.65625} \
   CONFIG.CLKOUT2_DRIVES {BUFG} \
   CONFIG.CLKOUT2_JITTER {189.047} \
   CONFIG.CLKOUT2_PHASE_ERROR {170.782} \
   ...
   CONFIG.MMCM_CLKIN1_PERIOD {20.480} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.000} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {9} \
   CONFIG.MMCM_CLKOUT1_DIVIDE {1} \
   CONFIG.MMCM_COMPENSATION {ZHOLD} \
   CONFIG.NUM_OUT_CLKS {1} \
   CONFIG.PLL_CLKIN_PERIOD {20.480} \
   CONFIG.PRIMITIVE {PLL} \
   CONFIG.PRIM_IN_FREQ {48.828125} \
   CONFIG.USE_RESET {false} \
 ] $clk_wiz_0

  # Create instance: core_status, and set properties
  set core_status [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 core_status ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {8} \
 ] $core_status

  # Create instance: core_status1, and set properties
  set core_status1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 core_status1 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {8} \
 ] $core_status1

  # Create instance: core_status2, and set properties
  set core_status2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 core_status2 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {8} \
 ] $core_status2

  # Create instance: core_status3, and set properties
  set core_status3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 core_status3 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {8} \
 ] $core_status3

  # Create instance: core_status4, and set properties
  set core_status4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 core_status4 ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {8} \
 ] $core_status4

  # Create instance: data_downconverter10
  create_hier_cell_data_downconverter10 $hier_obj data_downconverter10

  # Create instance: data_downconverter11
  create_hier_cell_data_downconverter11 $hier_obj data_downconverter11

  # Create instance: data_downconverter12
  create_hier_cell_data_downconverter12 $hier_obj data_downconverter12

  # Create instance: data_downconverter13
  create_hier_cell_data_downconverter13 $hier_obj data_downconverter13

  # Create instance: data_upconverter1
  create_hier_cell_data_upconverter1 $hier_obj data_upconverter1

  # Create instance: data_upconverter2
  create_hier_cell_data_upconverter2 $hier_obj data_upconverter2

  # Create instance: data_upconverter3
  create_hier_cell_data_upconverter3 $hier_obj data_upconverter3
  ...
  # Create instance: xlconstant_zero_0, and set properties
  set xlconstant_zero_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_zero_0 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $xlconstant_zero_0
  ...
  connect_bd_intf_net -intf_net GT_DIFF_REFCLK_125_1 [get_bd_intf_pins GT_DIFF_REFCLK_125] [get_bd_intf_pins aurora_64b66b_0/GT_DIFF_REFCLK1]
  connect_bd_intf_net -intf_net GT_SERIAL_RX1_1 [get_bd_intf_pins GT_SERIAL_RX1] [get_bd_intf_pins aurora_64b66b_1/GT_SERIAL_RX]
  connect_bd_intf_net -intf_net GT_SERIAL_RX2_1 [get_bd_intf_pins GT_SERIAL_RX2] [get_bd_intf_pins aurora_64b66b_2/GT_SERIAL_RX]
  connect_bd_intf_net -intf_net GT_SERIAL_RX3_1 [get_bd_intf_pins GT_SERIAL_RX3] [get_bd_intf_pins aurora_64b66b_3/GT_SERIAL_RX]
  connect_bd_intf_net -intf_net GT_SERIAL_RX_1 [get_bd_intf_pins GT_SERIAL_RX] [get_bd_intf_pins aurora_64b66b_0/GT_SERIAL_RX]
  connect_bd_intf_net -intf_net GT_TEST_SERIAL_RX_1 [get_bd_intf_pins GT_TEST_SERIAL_RX] [get_bd_intf_pins aurora_64b66b_4/GT_SERIAL_RX]
  connect_bd_intf_net -intf_net S_AXI_STREAM_1 [get_bd_intf_pins aurora_64b66b_1/USER_DATA_M_AXIS_RX] [get_bd_intf_pins data_downconverter12/S_AXI_STREAM]
  connect_bd_intf_net -intf_net S_AXI_STREAM_2 [get_bd_intf_pins aurora_64b66b_2/USER_DATA_M_AXIS_RX] [get_bd_intf_pins data_downconverter10/S_AXI_STREAM]
  connect_bd_intf_net -intf_net TEST_DATA_S_AXI_TX_1 [get_bd_intf_pins TEST_DATA_S_AXI_TX] [get_bd_intf_pins data_upconverter3/S_AXI_STREAM]
  connect_bd_intf_net -intf_net USER_DATA_S_AXI_TX2_1 [get_bd_intf_pins USER_DATA_S_AXI_TX2] [get_bd_intf_pins data_upconverter1/S_AXI_STREAM]
  connect_bd_intf_net -intf_net USER_DATA_S_AXI_TX3_1 [get_bd_intf_pins USER_DATA_S_AXI_TX3] [get_bd_intf_pins data_upconverter2/S_AXI_STREAM]
  connect_bd_intf_net -intf_net aurora_64b66b_0_GT_SERIAL_TX [get_bd_intf_pins GT_SERIAL_TX] [get_bd_intf_pins aurora_64b66b_0/GT_SERIAL_TX]
  connect_bd_intf_net -intf_net aurora_64b66b_0_USER_DATA_M_AXIS_RX [get_bd_intf_pins aurora_64b66b_0/USER_DATA_M_AXIS_RX] [get_bd_intf_pins data_downconverter13/S_AXI_STREAM]
  connect_bd_intf_net -intf_net aurora_64b66b_1_GT_SERIAL_TX [get_bd_intf_pins GT_SERIAL_TX3] [get_bd_intf_pins aurora_64b66b_3/GT_SERIAL_TX]
  connect_bd_intf_net -intf_net aurora_64b66b_1_GT_SERIAL_TX1 [get_bd_intf_pins GT_SERIAL_TX1] [get_bd_intf_pins aurora_64b66b_1/GT_SERIAL_TX]
  connect_bd_intf_net -intf_net aurora_64b66b_2_GT_SERIAL_TX [get_bd_intf_pins GT_SERIAL_TX2] [get_bd_intf_pins aurora_64b66b_2/GT_SERIAL_TX]
  connect_bd_intf_net -intf_net aurora_64b66b_3_USER_DATA_M_AXIS_RX [get_bd_intf_pins aurora_64b66b_3/USER_DATA_M_AXIS_RX] [get_bd_intf_pins data_downconverter11/S_AXI_STREAM]
  connect_bd_intf_net -intf_net aurora_64b66b_4_GT_SERIAL_TX [get_bd_intf_pins GT_TEST_SERIAL_TX] [get_bd_intf_pins aurora_64b66b_4/GT_SERIAL_TX]
  connect_bd_intf_net -intf_net data_downconverter10_M_AXI_STREAM [get_bd_intf_pins USER_DATA_M_AXI_RX2] [get_bd_intf_pins data_downconverter10/M_AXI_STREAM]
  connect_bd_intf_net -intf_net data_downconverter11_M_AXI_STREAM [get_bd_intf_pins USER_DATA_M_AXI_RX3] [get_bd_intf_pins data_downconverter11/M_AXI_STREAM]
  connect_bd_intf_net -intf_net data_downconverter12_M_AXI_STREAM [get_bd_intf_pins USER_DATA_M_AXI_RX1] [get_bd_intf_pins data_downconverter12/M_AXI_STREAM]
  connect_bd_intf_net -intf_net data_downconverter13_M_AXI_STREAM [get_bd_intf_pins USER_DATA_M_AXI_RX] [get_bd_intf_pins data_downconverter13/M_AXI_STREAM]
  connect_bd_intf_net -intf_net data_upconverter1_M_AXI_STREAM [get_bd_intf_pins aurora_64b66b_2/USER_DATA_S_AXIS_TX] [get_bd_intf_pins data_upconverter1/M_AXI_STREAM]
  connect_bd_intf_net -intf_net data_upconverter2_M_AXI_STREAM [get_bd_intf_pins aurora_64b66b_3/USER_DATA_S_AXIS_TX] [get_bd_intf_pins data_upconverter2/M_AXI_STREAM]
  connect_bd_intf_net -intf_net data_upconverter3_M_AXI_STREAM [get_bd_intf_pins aurora_64b66b_4/USER_DATA_S_AXIS_TX] [get_bd_intf_pins data_upconverter3/M_AXI_STREAM]
  connect_bd_intf_net -intf_net drp_bridge_0_DRP0 [get_bd_intf_pins aurora_64b66b_0/CHANNEL_DRP_IF0] [get_bd_intf_pins drp_bridge_0/DRP0]
  connect_bd_intf_net -intf_net drp_bridge_0_DRP1 [get_bd_intf_pins aurora_64b66b_1/CHANNEL_DRP_IF0] [get_bd_intf_pins drp_bridge_0/DRP1]
  connect_bd_intf_net -intf_net drp_bridge_0_DRP2 [get_bd_intf_pins aurora_64b66b_2/CHANNEL_DRP_IF0] [get_bd_intf_pins drp_bridge_0/DRP2]
  connect_bd_intf_net -intf_net drp_bridge_0_DRP3 [get_bd_intf_pins aurora_64b66b_3/CHANNEL_DRP_IF0] [get_bd_intf_pins drp_bridge_0/DRP3]
  connect_bd_intf_net -intf_net drp_bridge_0_DRP4 [get_bd_intf_pins aurora_64b66b_4/CHANNEL_DRP_IF0] [get_bd_intf_pins drp_bridge_0/DRP4]

  # Create port connections
  connect_bd_net -net AXI_aclk_1 [get_bd_pins AXI_aclk] [get_bd_pins aurora_64b66b_0/drp_clk_in] [get_bd_pins aurora_64b66b_1/drp_clk_in] [get_bd_pins aurora_64b66b_2/drp_clk_in] [get_bd_pins aurora_64b66b_3/drp_clk_in] [get_bd_pins aurora_64b66b_4/drp_clk_in] [get_bd_pins drp_bridge_0/AXI_aclk]
  connect_bd_net -net AXI_aresetn_1 [get_bd_pins AXI_aresetn] [get_bd_pins drp_bridge_0/AXI_aresetn]
  connect_bd_net -net aurora_64b66b_0_channel_up [get_bd_pins aurora_64b66b_0/channel_up] [get_bd_pins core_status3/In0]
  connect_bd_net -net aurora_64b66b_0_crc_pass_fail_n [get_bd_pins aurora_64b66b_0/crc_pass_fail_n] [get_bd_pins core_status3/In1]
  connect_bd_net -net aurora_64b66b_0_crc_valid [get_bd_pins aurora_64b66b_0/crc_valid] [get_bd_pins core_status3/In2]
  connect_bd_net -net aurora_64b66b_0_gt_pll_lock [get_bd_pins aurora_64b66b_0/gt_pll_lock] [get_bd_pins core_status3/In3]
  connect_bd_net -net aurora_64b66b_0_hard_err [get_bd_pins aurora_64b66b_0/hard_err] [get_bd_pins core_status3/In4]
  connect_bd_net -net aurora_64b66b_0_lane_up [get_bd_pins aurora_64b66b_0/lane_up] [get_bd_pins core_status3/In5]
  connect_bd_net -net aurora_64b66b_0_mmcm_not_locked_out [get_bd_pins aurora_64b66b_0/mmcm_not_locked_out] [get_bd_pins core_status3/In7]
  connect_bd_net -net aurora_64b66b_0_soft_err [get_bd_pins aurora_64b66b_0/soft_err] [get_bd_pins core_status3/In6]
  connect_bd_net -net aurora_64b66b_1_channel_up [get_bd_pins aurora_64b66b_1/channel_up] [get_bd_pins core_status/In0]
  connect_bd_net -net aurora_64b66b_1_crc_pass_fail_n [get_bd_pins aurora_64b66b_1/crc_pass_fail_n] [get_bd_pins core_status/In1]
  connect_bd_net -net aurora_64b66b_1_crc_valid [get_bd_pins aurora_64b66b_1/crc_valid] [get_bd_pins core_status/In2]
  connect_bd_net -net aurora_64b66b_1_gt_pll_lock [get_bd_pins aurora_64b66b_1/gt_pll_lock] [get_bd_pins core_status/In3]
  connect_bd_net -net aurora_64b66b_1_hard_err [get_bd_pins aurora_64b66b_1/hard_err] [get_bd_pins core_status/In4]
  connect_bd_net -net aurora_64b66b_1_lane_up [get_bd_pins aurora_64b66b_1/lane_up] [get_bd_pins core_status/In5]
  connect_bd_net -net aurora_64b66b_1_soft_err [get_bd_pins aurora_64b66b_1/soft_err] [get_bd_pins core_status/In6]
  connect_bd_net -net aurora_64b66b_2_channel_up [get_bd_pins aurora_64b66b_2/channel_up] [get_bd_pins core_status1/In0]
  connect_bd_net -net aurora_64b66b_2_crc_pass_fail_n [get_bd_pins aurora_64b66b_2/crc_pass_fail_n] [get_bd_pins core_status1/In1]
  connect_bd_net -net aurora_64b66b_2_crc_valid [get_bd_pins aurora_64b66b_2/crc_valid] [get_bd_pins core_status1/In2]
  connect_bd_net -net aurora_64b66b_2_gt_pll_lock [get_bd_pins aurora_64b66b_2/gt_pll_lock] [get_bd_pins core_status1/In3]
  connect_bd_net -net aurora_64b66b_2_hard_err [get_bd_pins aurora_64b66b_2/hard_err] [get_bd_pins core_status1/In4]
  connect_bd_net -net aurora_64b66b_2_lane_up [get_bd_pins aurora_64b66b_2/lane_up] [get_bd_pins core_status1/In5]
  connect_bd_net -net aurora_64b66b_2_soft_err [get_bd_pins aurora_64b66b_2/soft_err] [get_bd_pins core_status1/In6]
  connect_bd_net -net aurora_64b66b_3_channel_up [get_bd_pins aurora_64b66b_3/channel_up] [get_bd_pins core_status2/In0]
  connect_bd_net -net aurora_64b66b_3_crc_pass_fail_n [get_bd_pins aurora_64b66b_3/crc_pass_fail_n] [get_bd_pins core_status2/In1]
  connect_bd_net -net aurora_64b66b_3_crc_valid [get_bd_pins aurora_64b66b_3/crc_valid] [get_bd_pins core_status2/In2]
  connect_bd_net -net aurora_64b66b_3_gt_pll_lock [get_bd_pins aurora_64b66b_3/gt_pll_lock] [get_bd_pins core_status2/In3]
  connect_bd_net -net aurora_64b66b_3_hard_err [get_bd_pins aurora_64b66b_3/hard_err] [get_bd_pins core_status2/In4]
  connect_bd_net -net aurora_64b66b_3_lane_up [get_bd_pins aurora_64b66b_3/lane_up] [get_bd_pins core_status2/In5]
  connect_bd_net -net aurora_64b66b_3_soft_err [get_bd_pins aurora_64b66b_3/soft_err] [get_bd_pins core_status2/In6]
  connect_bd_net -net aurora_64b66b_4_channel_up [get_bd_pins aurora_64b66b_4/channel_up] [get_bd_pins core_status4/In0]
  connect_bd_net -net aurora_64b66b_4_crc_pass_fail_n [get_bd_pins aurora_64b66b_4/crc_pass_fail_n] [get_bd_pins core_status4/In1]
  connect_bd_net -net aurora_64b66b_4_crc_valid [get_bd_pins aurora_64b66b_4/crc_valid] [get_bd_pins core_status4/In2]
  connect_bd_net -net aurora_64b66b_4_gt_pll_lock [get_bd_pins aurora_64b66b_4/gt_pll_lock] [get_bd_pins core_status4/In3]
  connect_bd_net -net aurora_64b66b_4_hard_err [get_bd_pins aurora_64b66b_4/hard_err] [get_bd_pins core_status4/In4]
  connect_bd_net -net aurora_64b66b_4_lane_up [get_bd_pins aurora_64b66b_4/lane_up] [get_bd_pins core_status4/In5]
  connect_bd_net -net aurora_64b66b_4_soft_err [get_bd_pins aurora_64b66b_4/soft_err] [get_bd_pins core_status4/In6]
  connect_bd_net -net aurora_8b10b_0_gt_refclk1_out [get_bd_pins auroraRefClk] [get_bd_pins aurora_64b66b_0/gt_refclk1_out] [get_bd_pins aurora_64b66b_1/refclk1_in] [get_bd_pins aurora_64b66b_2/refclk1_in] [get_bd_pins aurora_64b66b_3/refclk1_in] [get_bd_pins aurora_64b66b_4/refclk1_in]
  connect_bd_net -net aurora_8b10b_0_gt_reset_out [get_bd_pins gtxResetOut] [get_bd_pins aurora_64b66b_0/gt_reset_out] [get_bd_pins aurora_64b66b_1/pma_init] [get_bd_pins aurora_64b66b_2/pma_init] [get_bd_pins aurora_64b66b_3/pma_init] [get_bd_pins aurora_64b66b_4/pma_init]
  connect_bd_net -net aurora_8b10b_0_pll_not_locked_out [get_bd_pins pll_not_locked_out] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net aurora_8b10b_0_sync_clk_out [get_bd_pins aurora_64b66b_0/sync_clk_out] [get_bd_pins aurora_64b66b_1/sync_clk] [get_bd_pins aurora_64b66b_2/sync_clk] [get_bd_pins aurora_64b66b_3/sync_clk] [get_bd_pins aurora_64b66b_4/sync_clk]
  connect_bd_net -net aurora_8b10b_0_user_clk_out [get_bd_pins aurora_64b66b_0/user_clk_out] [get_bd_pins aurora_64b66b_1/user_clk] [get_bd_pins aurora_64b66b_2/user_clk] [get_bd_pins aurora_64b66b_3/user_clk] [get_bd_pins aurora_64b66b_4/user_clk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins data_downconverter10/S_CLK] [get_bd_pins data_downconverter11/S_CLK] [get_bd_pins data_downconverter12/S_CLK] [get_bd_pins data_downconverter13/S_CLK] [get_bd_pins data_upconverter1/M_CLK] [get_bd_pins data_upconverter2/M_CLK] [get_bd_pins data_upconverter3/M_CLK]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins user_clk_out] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins data_downconverter10/M_CLK] [get_bd_pins data_downconverter11/M_CLK] [get_bd_pins data_downconverter12/M_CLK] [get_bd_pins data_downconverter13/M_CLK] [get_bd_pins data_upconverter1/S_CLK] [get_bd_pins data_upconverter2/S_CLK] [get_bd_pins data_upconverter3/S_CLK]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net core_status1_dout [get_bd_pins core_status1/dout] [get_bd_pins data_downconverter10/STATUS_IN]
  connect_bd_net -net core_status2_dout [get_bd_pins core_status2/dout] [get_bd_pins data_downconverter11/STATUS_IN]
  connect_bd_net -net core_status3_dout [get_bd_pins core_status3/dout] [get_bd_pins data_downconverter13/STATUS_IN]
  connect_bd_net -net core_status4_dout [get_bd_pins CORE_TEST_STATUS] [get_bd_pins core_status4/dout]
  connect_bd_net -net core_status_dout [get_bd_pins core_status/dout] [get_bd_pins data_downconverter12/STATUS_IN]
  connect_bd_net -net data_downconverter10_STATUS_OUT [get_bd_pins CORE_STATUS2] [get_bd_pins data_downconverter10/STATUS_OUT]
  connect_bd_net -net data_downconverter11_STATUS_OUT [get_bd_pins CORE_STATUS3] [get_bd_pins data_downconverter11/STATUS_OUT]
  connect_bd_net -net data_downconverter12_STATUS_OUT [get_bd_pins CORE_STATUS1] [get_bd_pins data_downconverter12/STATUS_OUT]
  connect_bd_net -net data_downconverter13_STATUS_OUT [get_bd_pins CORE_STATUS] [get_bd_pins data_downconverter13/STATUS_OUT]
  connect_bd_net -net gt_reset_1 [get_bd_pins gtxReset] [get_bd_pins aurora_64b66b_0/pma_init]
  connect_bd_net -net init_clk_in_1 [get_bd_pins init_clk_in] [get_bd_pins aurora_64b66b_0/init_clk] [get_bd_pins aurora_64b66b_1/init_clk] [get_bd_pins aurora_64b66b_2/init_clk] [get_bd_pins aurora_64b66b_3/init_clk] [get_bd_pins aurora_64b66b_4/init_clk]
  connect_bd_net -net reset_1 [get_bd_pins auroraReset] [get_bd_pins aurora_64b66b_0/reset_pb] [get_bd_pins aurora_64b66b_1/reset_pb] [get_bd_pins aurora_64b66b_2/reset_pb] [get_bd_pins aurora_64b66b_3/reset_pb] [get_bd_pins aurora_64b66b_4/reset_pb] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins data_downconverter10/reset_n] [get_bd_pins data_downconverter11/reset_n] [get_bd_pins data_downconverter12/reset_n] [get_bd_pins data_downconverter13/reset_n] [get_bd_pins data_upconverter1/reset_n] [get_bd_pins data_upconverter2/reset_n] [get_bd_pins data_upconverter3/reset_n] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins gt0_qplllock_out] [get_bd_pins gt0_qpllrefclklost_out] [get_bd_pins xlconstant_one/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins aurora_64b66b_1/gt_qpllclk_quad2_in] [get_bd_pins aurora_64b66b_1/gt_qpllrefclk_quad2_in] [get_bd_pins aurora_64b66b_2/gt_qpllclk_quad1_in] [get_bd_pins aurora_64b66b_2/gt_qpllrefclk_quad1_in] [get_bd_pins aurora_64b66b_3/gt_qpllclk_quad1_in] [get_bd_pins aurora_64b66b_3/gt_qpllrefclk_quad1_in] [get_bd_pins aurora_64b66b_4/gt_qpllclk_quad1_in] [get_bd_pins aurora_64b66b_4/gt_qpllrefclk_quad1_in] [get_bd_pins xlconstant_zero/dout]
  connect_bd_net -net xlconstant_5_dout [get_bd_pins core_status/In7] [get_bd_pins core_status1/In7] [get_bd_pins core_status2/In7] [get_bd_pins core_status4/In7] [get_bd_pins xlconstant_zero_0/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BPM_CCW_AuroraCoreStatus [ create_bd_port -dir O -from 7 -to 0 BPM_CCW_AuroraCoreStatus ]
  set BPM_CW_AuroraCoreStatus [ create_bd_port -dir O -from 7 -to 0 BPM_CW_AuroraCoreStatus ]
  set BPM_TEST_AuroraCoreStatus [ create_bd_port -dir O -from 7 -to 0 BPM_TEST_AuroraCoreStatus ]
  ...
  set CELL_CCW_AuroraCoreStatus [ create_bd_port -dir O -from 7 -to 0 CELL_CCW_AuroraCoreStatus ]
  set CELL_CW_AuroraCoreStatus [ create_bd_port -dir O -from 7 -to 0 CELL_CW_AuroraCoreStatus ]
  ...
  set gt0_qplllock_out [ create_bd_port -dir O -from 0 -to 0 gt0_qplllock_out ]
  set gt0_qpllrefclklost_out [ create_bd_port -dir O -from 0 -to 0 gt0_qpllrefclklost_out ]
  set gtxReset [ create_bd_port -dir I -type rst gtxReset ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] $gtxReset
  set gtxResetOut [ create_bd_port -dir O -type rst gtxResetOut ]
  set pll_not_locked_out [ create_bd_port -dir O -from 0 -to 0 pll_not_locked_out ]
  ...
  # Create port connections
  connect_bd_net -net Aurora_CORE_STATUS [get_bd_ports BPM_CCW_AuroraCoreStatus] [get_bd_pins Aurora/CORE_STATUS]
  connect_bd_net -net Aurora_CORE_STATUS1 [get_bd_ports BPM_CW_AuroraCoreStatus] [get_bd_pins Aurora/CORE_STATUS1]
  connect_bd_net -net Aurora_CORE_STATUS2 [get_bd_ports CELL_CCW_AuroraCoreStatus] [get_bd_pins Aurora/CORE_STATUS2]
  connect_bd_net -net Aurora_CORE_STATUS3 [get_bd_ports CELL_CW_AuroraCoreStatus] [get_bd_pins Aurora/CORE_STATUS3]
  connect_bd_net -net Aurora_CORE_TEST_STATUS [get_bd_ports BPM_TEST_AuroraCoreStatus] [get_bd_pins Aurora/CORE_TEST_STATUS]
