...
set evrmgt [create_ip -name gtwizard -vendor xilinx.com -library ip -version 3.6 -module_name evrmgt]

set_property -dict {
  CONFIG.identical_val_tx_line_rate {2.4982}
  CONFIG.identical_val_no_tx {false}
  CONFIG.identical_val_rx_line_rate {2.4982}
  ...
  CONFIG.gt5_val {true}
  CONFIG.gt5_val_tx_refclk {REFCLK0_Q0}
  CONFIG.gt5_val_rx_refclk {REFCLK0_Q0}
  ...
  CONFIG.identical_val_tx_reference_clock {124.910}
  CONFIG.identical_val_rx_reference_clock {124.910}
  CONFIG.gt0_val_no_tx {false}
  CONFIG.gt0_val_tx_line_rate {2.4982}
  CONFIG.gt0_val_tx_data_width {16}
  CONFIG.gt0_val_encoding {8B/10B}
  CONFIG.gt0_val_tx_int_datawidth {20}
  CONFIG.gt0_val_tx_reference_clock {124.910}
  CONFIG.gt0_val_rx_line_rate {2.4982}
  CONFIG.gt0_val_rx_data_width {16}
  CONFIG.gt0_val_decoding {8B/10B}
  CONFIG.gt0_val_rx_int_datawidth {20}
  CONFIG.gt0_val_rx_reference_clock {124.910}
