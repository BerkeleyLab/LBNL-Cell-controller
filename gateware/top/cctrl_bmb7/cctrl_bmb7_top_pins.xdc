...
set_property PACKAGE_PIN C14 [get_ports {K7_EXT_IO[0]}]
set_property PACKAGE_PIN C13 [get_ports {K7_EXT_IO[1]}]
set_property PACKAGE_PIN D14 [get_ports {K7_EXT_IO[2]}]
set_property PACKAGE_PIN F14 [get_ports {K7_EXT_IO[3]}]
set_property PACKAGE_PIN G14 [get_ports {K7_EXT_IO[4]}]
set_property PACKAGE_PIN F13 [get_ports {K7_EXT_IO[5]}]
set_property PACKAGE_PIN D11 [get_ports {K7_EXT_IO[6]}]
set_property PACKAGE_PIN F12 [get_ports {K7_EXT_IO[7]}]
set_property PACKAGE_PIN G12 [get_ports {K7_EXT_IO[8]}]
set_property PACKAGE_PIN F10 [get_ports {K7_EXT_IO[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {K7_EXT_IO[9]}]
