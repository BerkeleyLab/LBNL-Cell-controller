...
# system MMCM clocks
set CLKOUT0_clk                         [get_clocks -of_objects [get_pins system_i/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0]]
set CLKOUT0_period                      [get_property PERIOD $CLKOUT0_clk]

set CLKOUT1_clk                         [get_clocks -of_objects [get_pins system_i/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT1]]
set CLKOUT1_period                      [get_property PERIOD $CLKOUT1_clk]

set CLKOUT2_clk                         [get_clocks -of_objects [get_pins system_i/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2]]
set CLKOUT2_period                      [get_property PERIOD $CLKOUT2_clk]

set CLKOUT3_clk                         [get_clocks -of_objects [get_pins system_i/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT3]]
set CLKOUT3_period                      [get_property PERIOD $CLKOUT3_clk]

set CLKOUT4_clk                         [get_clocks -of_objects [get_pins system_i/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT4]]
...
set FOFBETHCLK_clk                      [get_clocks -of_objects [get_pins psTx/PCS_PMA/inst/core_clocking_i/mmcm_adv_inst/CLKOUT0]]
