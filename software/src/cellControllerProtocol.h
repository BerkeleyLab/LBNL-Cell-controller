...
#define CC_PROTOCOL_CMD_HI_SET_EEBI_CONFIG  0x0700
#define CC_PROTOCOL_EEBI_CONFIG_ID_MASK (CC_PROTOCOL_FOFB_CAPACITY_PER_PLANE-1)
#define CC_PROTOCOL_EEBI_CONFIG_PLANE_MASK CC_PROTOCOL_FOFB_CAPACITY_PER_PLANE

#define CC_PROTOCOL_CMD_HI_GET_EEBI         0x0800
...
#define CC_PROTOCOL_CMD_LONGOUT_IDX_CLEAR_EEBI_TRIP         0x09
