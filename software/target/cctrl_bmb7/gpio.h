...
#define GPIO_READ(i)    Xil_In32(XPAR_AXI_LITE_GENERIC_REG_S00_AXI_BASEADDR+(4*(i)))
#define GPIO_WRITE(i,x) Xil_Out32(XPAR_AXI_LITE_GENERIC_REG_S00_AXI_BASEADDR+(4*(i)),(x))
